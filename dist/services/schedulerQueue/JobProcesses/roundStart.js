...
class RoundStart extends init_1.Initializer {
    constructor() {
        ...
        this.worker = (0, instrumentedWorker_1.createInstrumentedWorker)(this.Queue.name, (job) => this.roundStartProcess(job), Object.assign({ connection: this.Queue.opts.connection, 
