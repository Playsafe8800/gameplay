...
export declare const ZKDefaults: Readonly<{
...
export declare const BOT_CONFIG: Readonly<{
...
export declare const MESSAGES: {
    ...
    CONNECTED: string;
    NEW_DATA_EVENT: string;
    CONNECTION_ESTABLISHED: string;
    NEW_EVENT: string;
    CATCH_ERROR: string;
};
export declare const GAME_END_REASONS_INSTRUMENTATION: Readonly<{
    DROP: "Drop";
...
export declare const PM2_ERRORS: {
    KEY_NOT_FOUND: string;
    KEY_MISMATCHED: string;
    HOSTNAME_MISMATCHED: string;
    ZK_KEY_MISMATCHED: string;
...
export declare const LEAVE_TABLE_REASONS: {
    MANUAL_SPLIT: string;
    LOST: string;
    ELIMINATED: string;
    GRPC_FAILED: string;
    DISCONNECTED_BEFORE_GAME_START: string;
    SWITCH: string;
    NO_BALANCE: string;
    REMOVED_VIA_GLOBAL_MM: string;
    AUTO_REMOVABLE_TABLE: string;
    DEBIT_VALIDATION_FAILED: string;
    PLAY_MORE: string;
    REBUYS_EXIT: string;
};
export declare const DEPLOYMENT_CONSTANTS: {
...
export declare const TABLE_PREFIX: {
    ...
    GAME_TABLE: string;
    PLAYER: string;
    TABLE_GAME_PLAY: string;
    PLAYER_GAME_PLAY: string;
    TURN_HISTORY: string;
    ROUND_SCORE_CARD: string;
    ROUND_SCORE_BOARD: string;
    SPLIT_REQUEST: string;
    OPEN_DISCARDED_CARDS: string;
    STATE: string;
    LOBBY: string;
    PLAY_MORE: string;
    INAPP_PURCHASE: string;
    INAPP_PURCHASE_ELIGIBILITY: string;
};
export declare const RUMMY_TYPES: {
    POOL: string;
    POINTS: string;
    DEALS: string;
    MULTI_TABLE_RUMMY: string;
    MULTI_TABLE_DEALS_RUMMY: string;
    MULTI_TABLE_POOL_RUMMY: string;
    MULTI_TABLE_POINTS_RUMMY: string;
};
export declare const GAME_IDS: {
    POOL: number;
    DEALS: number;
    POINTS: number;
};
...
export declare const POINTS: {
    MAX_DEADWOOD_POINTS: number;
    MAX_DEADWOOD_POINTS_61: number;
    FIRST_DROP: number;
    MIDDLE_DROP: number;
    FIRST_DROP_201: number;
    MIDDLE_DROP_201: number;
    FIRST_DROP_61: number;
    MIDDLE_DROP_61: number;
    LATE_DECLARE_PENALTY_POINTS: number;
    TIMEOUT_DROP: number;
    MANUAL_LEAVE_PENALTY_POINTS: number;
};
...
export declare const POPUP_TITLES: {
    ALERT: string;
    FAIRPLAY_VIOLATION: string;
    PLAY_MORE: string;
    INSUFFICIENT_FUND: string;
};
export declare const COUNTRY: {
    IN: string;
};
export declare const SPLIT: {
    TWO_PLAYER_SPLIT: string;
    THREE_PLAYER_SPLIT: string;
    POPUP_MSG: string;
};
export declare const OPEN_POPUP_ACTION: {
    DROP: string;
    DECLARE: string;
    EXIT: string;
};
export declare const SNS_KEYS: {
    FINISH_TABLE_KEY: string;
};
export declare const SPLIT_STATUS: {
    ACCEPTED: string;
    REJECTED: string;
    NOT_RESPONDED: string;
};
export declare const DEFAULT_COINTS: {
    COINS: 100;
};
