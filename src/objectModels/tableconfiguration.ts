export interface TableConfiguration {
  ...
  isSplitable: boolean;
  rebuyUsed?: boolean; // useRebuy: It will be true on accepting rebuy
  isNewGameTableUI?: boolean; // isNewUI: It will be true on new game table UI
...
export interface LobbyGameConfig {
  ...
  MaxPoints: number;
  RummyTips: boolean;
  Round_count?: number; // deals count
  ShowEmoji: boolean;
  GameFormat: string;
  MaxPlayers: number;
  MinPlayers: number;
