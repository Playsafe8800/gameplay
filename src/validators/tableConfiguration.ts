  ...
  joiSchemaValidator() {
    return Joi.object().keys({
      ...
      currencyType: Joi.string()
        ...
        .required(),
      isRTPHandlingEnabled: Joi.boolean().required().default(false),
      featureNameForRTP: Joi.string().optional().allow(''),
    });
  }
}

export const tableConfigurationValidator = new TableConfiguration();
